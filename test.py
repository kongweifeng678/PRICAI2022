...
def parse_arguments(args):
    ...
    parser.add_argument("--vis_path", default="/home/wolian/disk1/Stanford2D3D/", type=str, help="path to the dataset.")    
...
if __name__ == "__main__":
    ...
    test_data = dataset.dataset_360D.Dataset360D(args.test_path, " ", args.configuration, [height, width], '../SVS_norm/vps/')
    ...
    errors = numpy.zeros((7, 1484), numpy.float32)
    ...
    with torch.no_grad():            
        ...
        for test_batch_id , test_batch in enumerate(test_data_iterator):
            ...
            name = test_batch['leftDepth_filename']
            ...
            left_depth_pred = model(left_rgb)
            ...
            if args.save_samples:
                ...
                saver.save_samples(test_batch['leftRGB'], left_depth, left_depth_pred)
